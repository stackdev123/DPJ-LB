    ...
    <div className="min-h-screen bg-slate-100 font-sans text-slate-900 flex relative overflow-hidden">
      ...
      `}>
        ...
        <div className={`mx-auto print:max-w-none w-full transition-all duration-300 ${
            ...
            {currentView === AppView.PURCHASE_LIST && <PurchaseList purchases={purchases} sales={sales} onEditPurchase={handleOpenPurchaseEditModal} onSellPurchase={handleInputSaleFromRecap} onNewPurchase={() => setCurrentView(AppView.PURCHASE)} onDeletePurchase={handleDeletePurchase} user={user} />}
